...
RUN sed -i "s/;date.timezone =.*/date.timezone = America/Toronto/" /etc/php5/fpm/php.ini
RUN sed -i "s/;date.timezone =.*/date.timezone = America/Toronto/" /etc/php5/cli/php.ini
